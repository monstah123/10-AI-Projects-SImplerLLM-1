...
from SimplerLLM.language.embeddings import Embeddings, EmbeddingsProvider
...
llm_embedding_instance = Embeddings.create(provider=EmbeddingsProvider.OPENAI, model_name="text-embedding-ada-002")
